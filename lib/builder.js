...
Builder.prototype.javascript = function() {
  var jsTrees  = this.appAndDependencies();
  // TODO 
  // Pass applicationJs through HTMLBars compiler transforming hbs -> js, then treat it like a normal modules.
  // No more limitations on where the template is in the input tree
  
  jsTrees = jsTrees.map(function(tree) {
