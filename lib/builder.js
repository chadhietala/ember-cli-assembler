...
Builder.prototype.import = function(asset, options) {
 ...
 */
Builder.prototype._importAssetTree = function(directory, subdirectory) {
 ...
 */
Builder.prototype._getAssetPath = function(asset) {
  /** @type {String} */
  var assetPath;
...
Builder.prototype.vendor = function() {
