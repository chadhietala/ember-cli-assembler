...
Builder.prototype.appJavascript = function() {
  ...
  return mergeTrees([preprocessedApp, templates]);
};
...
Builder.prototype.styles = function() {
  ...
  styleTrees = styleTrees.concat(
    ...
    mv(this.trees.styles, this.name + '/styles')
  );
  ...
  var preprocessedStyles = preprocessCss(styles, '/app/styles', this.name + '/styles', options);
