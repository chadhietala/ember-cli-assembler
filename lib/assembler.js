...
Assembler.prototype.import = function(asset, options) {
  ...
  this._importAssetTree(directory, subdirectory, options.destDir);
  this._import(
    assetPath,
    options,
    directory,
...
/**
  ...
  @param {String} subdirectory
 */
Assembler.prototype._importAssetTree = function(directory, subdirectory, destDir) {
